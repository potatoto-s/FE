...
공예 산업은 성장하고 있지만, 공방 운영자들이 소통 및 정보 공유할 수 있는 플랫폼이 부족

공방 사장님들은 홍보 및 마케팅에 어려움을 겪음

기업과 공방이 연결될 수 있는 체계적인 시스템 필요

<br>

#### 2. 기획 의도

공방 사장님들에게 실질적인 도움을 줄 수 있는 소통 & 정보 공유의 장 마련

공방과 기업을 연결하여 공예 시장 활성화 기여

뉴스레터, 커뮤니티, 컨설팅을 통한 단순한 커뮤니티 이상의 가치 제공
...
주간 Top 10 게시글 (좋아요 기준)

각 카테고리별 최신 5개 게시글 표시
...
기업: 핸즈윗 컨설팅을 통해 준비된 공방 프로그램과 연결
...
커뮤니티 관리: 회원 전용 뉴스레터 제공 (비회원 열람 제한)

뉴스레터 공개 범위 설정 (전체 공개 & 회원 공개 구분)

커뮤니티 사용자를 위한 챗봇 구현

대댓글 기능 구현

메인페이지 배너 slick 사용하여 구현
