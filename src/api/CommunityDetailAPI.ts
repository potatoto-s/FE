...
// // 게시글 작성 함수
// export const fetchPostDetail = async (post_id: number | string) => {
//   const response = await axiosInstance.get(`/api/posts/${post_id}/`);
//   return response.data;
// };

// // 게시글 삭제 함수
// export const deletePost = async (post_id: number) => {
//   await axiosAuthInstance.delete(`/api/posts/${post_id}/delete/`);
// };
...
//   const response = await axiosAuthInstance.post(
//     `/api/comment/${post_id}/comments/create/`,
//     { content }
//   );
//   return response.data;
// };
...
// // 게시글 좋아요 토글 함수
// export const toggleLikePost = async (is_liked: boolean, post_id: number) => {
//   const response = await axiosAuthInstance.post(`/api/posts/${post_id}/like/`, {
//     is_liked,
//   });
//   return response.data;
// };
