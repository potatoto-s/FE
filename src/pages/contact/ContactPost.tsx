const ContactPost = () => {
  return (
    ...
    >
      <div className="flex w-[81rem]">
        <h1 className="text-[#6E6E6E] text-[4.6rem] font-bold mr-[2.3rem] mb-[8.1rem]">
          CONTACT
        </h1>
        <p className="text-center pt-[2.8rem] text-[2rem] font-normal text-[#AEAEAE]">
